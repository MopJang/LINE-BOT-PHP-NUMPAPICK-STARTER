...
const char* ssid     = "PATJING399"; //change this to your SSID
const char* password = "SAN3242539"; //change this to your PASSWORD
...
#define KEY     "JW7IaeIME6NNsLPdf29emOZvu"     //change this to your KEY
#define SECRET  "PaymentAgent"     //change this to your SECRET
